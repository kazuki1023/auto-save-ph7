...
export default function CreatePage() {
  ...
  const handleNext = () => {
    if (selectedType && title) {
      router.push(`/create/${selectedType}?title=${encodeURIComponent(title)}`)
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-6 max-w-md">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">どんなイベント？</h1>
          <p className="text-sm text-gray-600">イベントの種類を選ぶと最適な入力方法になります</p>
        </div>
            ...
            return (
              <Card
                ...
                className={`cursor-pointer transition-all ${
                  selectedType === type.id ? "ring-2 ring-blue-500 bg-blue-50" : "hover:shadow-md"
                }`}
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex gap-2 mb-3">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs text-gray-600">{type.participants}</span>
                        </div>
                      </div>
        ...
        <Button onClick={handleNext} disabled={!selectedType || !title} className="w-full h-12 text-base">
          次へ進む
        </Button>
      </div>
    </div>
